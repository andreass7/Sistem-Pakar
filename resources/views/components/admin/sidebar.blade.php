<aside id="default-sidebar"
    class="fixed top-0 left-0 z-40 w-64 border-r h-screen transition-transform -translate-x-full sm:translate-x-0"
    aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50">
        <ul class="space-y-2 font-medium">
            <li>
                <x-admin.nav-link href="{{ route('Admin.home') }}" :active="request()->is('admin')">
            ...
            <li>
                <x-admin.nav-link href="{{ route('Admin.DataGejala') }}" :active="request()->is('admin-Data-Gejala')">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Data Gejala</span>
                </x-admin.nav-link>
            </li>
            <li>
                <x-admin.nav-link href="{{ route('Admin.RiwayatUser') }}" :active="request()->is('admin-riwayat')">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Riwayat User</span>

                </x-admin.nav-link>
            </li>
            <li>
                <x-admin.nav-link href="{{ route('Admin.Perhitungan') }}" :active="request()->is('admin-perhitungan')">

    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input id="name"
                class="block mt-1 w-full error-border  {{ $errors->has('name') ? 'border-red-500' : 'border-gray-300' }}"
        ...
        <div class="mt-4">
            ...
            <x-text-input id="email"
                class="block mt-1 w-full error-border
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password_confirmation"
                class="block mt-1 w-full error-border {{ $errors->has('password_confirmation') ? 'border-red-500' : 'border-gray-300' }}"
